...
const PROXY_RULES = {
  '/api/crew':    { target: 'http://localhost:8000', changeOrigin: true },
  '/api/semantic':{ target: 'http://localhost:8000', changeOrigin: true },
  '/api/ollama':  { target: 'http://localhost:8000', changeOrigin: true },
  '/ws/crew':     { target: 'ws://localhost:8000',   ws: true, changeOrigin: true },
